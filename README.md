...
- [TatNet](https://tatnet.ru) — Российская платформа управления инфраструктурой для быстрого запуска приложений и виртуальных машин. Поддерживает деплой из git, управление DNS и сетями, безсерверные функции из единой панели.\
  \[🌤️-free option]\[☁-Cloud]
